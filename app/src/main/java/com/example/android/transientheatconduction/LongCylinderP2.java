...
public class LongCylinderP2 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_long_cylinder_p2);
    ...
    public void calculate (View view){
        ...
        Double mi = Double.parseDouble(miste.getText().toString());
         ...
         if (mi == 0){
            ...
            Intent calcular = new Intent(LongCylinderP2.this, ResultLongCylinder2.class);
