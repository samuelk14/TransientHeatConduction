...
public class LargePlaneWallP2 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public void calculate (View view){
        ...
        String TA = extras1.getString("temAmb");

        Bundle extras2 = getIntent().getExtras();
        String TM = extras2.getString("temMat");

        Bundle extras3 = getIntent().getExtras();
        String TT = extras3.getString("temTim");

        Bundle extras4 = getIntent().getExtras();
        String CC = extras4.getString("conCoe");
        ...
        EditText therDiff = (EditText) findViewById(R.id.edittt4);
        String theDi = therDiff.getText().toString();
        ...
        if (L.isEmpty()){
            ...
            Intent calcular = new Intent(LargePlaneWallP2.this, ResultLargePlaneWallP.class);
        ...
        else if (theDi.isEmpty()){
            therDiff.setError("empty field");
            therDiff.requestFocus();
        }
            ...
            calcular.putExtra("thermDI", theDi);
            startActivity(calcular);
        }
