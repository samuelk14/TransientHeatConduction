...
public class ResultSphere2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_result_sphere2);
    ...
    private class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    ResultSphere22 resultSphere22;
                    resultSphere22 = new ResultSphere22();
                    return resultSphere22;
                case 1:
                    ResultSphere2g resultSphere2g;
                    resultSphere2g = new ResultSphere2g();
                    return resultSphere2g;
    ...
    public void graficar (View view){
        ...
        mChart = (LineChart) findViewById(R.id.graficaesfera2);
