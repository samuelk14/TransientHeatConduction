...
public class LongCylinder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_long_cylinder);
    ...
    public void siguiente (View view){
        ...
        if (getTA.isEmpty()){
            ...
            Intent next = new Intent(LongCylinder.this, LongCylinderP.class);
