...
public class SphereP extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sphere_p);
    ...
    public void calculate (View view){
        ...
        Double mi = Double.parseDouble(miste.getText().toString());
         ...
         if (mi == 0){
            ...
            Intent calcular = new Intent(SphereP.this, ResultSphere.class);
